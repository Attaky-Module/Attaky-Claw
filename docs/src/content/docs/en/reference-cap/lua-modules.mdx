...
| `environmental_sensor` | `lua_module_environmental_sensor` | Temperature, humidity, pressure, and gas data from supported environmental sensors |
| `event_publisher` | `lua_module_event_publisher` | Publish events from Lua into the Event Router |
| `lib_fuel_gauge` | `lua_module_fuel_gauge` | Pure-Lua battery fuel-gauge library |
