...
Attaky Claw uses Skills to manage context dynamically and extend the Agent—including driving hardware through documented tool flows.
...
Attaky Claw reads Skill metadata from JSON frontmatter at the top of each `SKILL.md`. The directory name, `name`, and built path must match: `skills/<skill_id>/SKILL.md`.
