...
const en: HomeContent = {
  metaTitle: "Attaky Claw — Chat-as-Coding Edge Agent Framework for IoT",
  metaDescription:
    "Attaky Claw — a Chat-as-Coding Edge Agent Framework for IoT, running on Attaky Agent Deck 1.0.",
  terminalTitle: "Attaky Claw — interactive demo",
  ...
  highlights: [
    ...
    },
    {
      ...
      detail: "Devices self-declare capabilities via MCP, replacing per-device adapters. Attaky Claw acts as both MCP Server and Client—exposing hardware to agents while calling external services.",
    },
    {
  ...
  whatsMissingAfterIoTP2: "Attaky Claw pushes the Agent Runtime directly to the edge, transforming ESP chips from passive \"execution nodes\" into active \"decision centers\" that perceive, reason, and act locally—breaking free from cloud dependency.",
  featAndDemos: [
    {
...
const zhCn: HomeContent = {
  metaTitle: "Attaky Claw — 「聊天造物」物联网 AI 智能体框架",
  metaDescription:
    "Attaky Claw —「聊天造物」物联网 AI 智能体框架，搭载于 Attaky Agent Deck 1.0。",
  terminalTitle: "Attaky Claw — 交互演示",
  ...
  highlights: [
    ...
    },
    {
      title: "即插即用",
      subtitle: "MCP 协议统一万物",
      detail: "设备通过 MCP 自声明能力，取代逐一适配。Attaky Claw 同时作为 MCP Server 和 Client，向 Agent 暴露硬件并调用外部服务。",
    },
    {
      title: "越用越懂你",
      subtitle: "芯片端本地记忆",
  ...
  whatsMissingAfterIoTP2: "Attaky Claw 将 Agent 运行时直接下沉至设备端，让 ESP 芯片化身为主动的“决策中心”——在本地完成感知、推理与决策的闭环，大幅减少云端依赖。",
  featAndDemos: [
    {
      title: "无须编程，「聊天造物」",
