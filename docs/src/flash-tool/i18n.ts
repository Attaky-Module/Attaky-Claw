...
const en: Strings = {
  ...
  wifiSameNetworkHint:
    "Make sure Attaky Claw and your browser are on the same network.",
  ...
  quickLinkNoHardwareDesc: "Assemble your Attaky Claw board",
...
const zhCn: Strings = {
  ...
  wifiSameNetworkHint: "请让 Attaky Claw 与当前浏览器连接到同一个网络。",
  ...
  quickLinkNoHardwareDesc: "组装 Attaky Claw 开发板",
