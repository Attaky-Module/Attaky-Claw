export const en = {
  ...
  webimDesc: 'Interact with Attaky Claw in real time via WebSocket.',
  webimSend: 'Send',
  webimOnline: 'Online',
  ...
  searchNote:
    'If set, Attaky Claw can search online. Tip: Built-in weather skill also relies on online search.',
